...
//
// Copyright (R) Vizor Games 2007-2018, All rights reserved.
// Part of Proto2Cpp converter, generating UE4 wrappers for GRPC.
//
// @author Raman Сhakhouski ir nezymiai Nikita Miroshnichenko :)
//
